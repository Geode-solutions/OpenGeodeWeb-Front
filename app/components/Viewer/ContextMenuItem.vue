<template>
  <div class="menu-item">
    ...
    <div v-if="is_active" class="menu-options pa-0" :class="optionsClass" @click.stop>
      <v-card @click.stop :title="props.tooltip" class="options-card" width="320" max-height="500" :ripple="false">
...
const optionsClass = computed(() => {
  ...
  if (isRightish) {
    if (menuStore.menuX + radius + margin + cardWidth > menuStore.containerWidth) {
      return "options-left"
    }
