...
const points_defaultColor = { r: 20, g: 20, b: 20, a: 1 };
const edges_defaultWidth = 2;
const edges_defaultColor = { r: 20, g: 20, b: 20, a: 1 };
const cells_defaultColor = { r: 255, g: 255, b: 255, a: 1 };
const polygons_defaultColor = { r: 255, g: 255, b: 255, a: 1 };
const polyhedra_defaultColor = { r: 255, g: 255, b: 255, a: 1 };

const corners_defaultVisibility = true;
const corners_defaultColor = { r: 20, g: 20, b: 20, a: 1 };
const lines_defaultVisibility = true;
const lines_defaultColor = { r: 20, g: 20, b: 20, a: 1 };
const surfaces_defaultVisibility = true;
const surfaces_defaultColor = { r: 255, g: 255, b: 255, a: 1 };
const blocks_defaultVisibility = true;
const blocks_defaultColor = { r: 255, g: 255, b: 255, a: 1 };
