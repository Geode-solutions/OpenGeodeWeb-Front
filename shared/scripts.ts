...
async function setAppBaseUrl(appBaseUrl: string) {
...
async function setBackBaseUrl(appBaseUrl: string, backBaseUrl: string) {
...
async function setViewerBaseUrl(appBaseUrl: string, viewerBaseUrl: string) {
...
async function setIsAppReady(appBaseUrl: string, isReady: boolean) {
...
async function getIsAppReady(appBaseUrl: string) {
