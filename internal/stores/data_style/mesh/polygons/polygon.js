...
// Local constants
const meshPolygonsPolygonAttributeSchemas = viewer_schemas.opengeodeweb_viewer.mesh.polygons.attribute.polygon;
...
function useMeshPolygonsPolygonAttributeStyle() {
  ...
  function setMeshPolygonsPolygonAttribute(id, {
    name,
    item,
    minimum,
    maximum,
