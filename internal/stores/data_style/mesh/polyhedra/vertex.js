...
// Local constants
const meshPolyhedraVertexAttributeSchemas = viewer_schemas.opengeodeweb_viewer.mesh.polyhedra.attribute.vertex;
...
function useMeshPolyhedraVertexAttributeStyle() {
  ...
  function setMeshPolyhedraVertexAttribute(id, {
    name,
    item,
    minimum,
    maximum,
